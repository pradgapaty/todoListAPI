            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                            <div>
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">addNewTask</h2>
                                <h3 class="mt-5 text-xxl text-gray-900 dark:text-white">Method: PUT</h3>
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    URL example: {server ip address}/api/addNewTask
                                </p>
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    Optional parameters:
                                    <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                ...
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    The first time a user adds a task, they receive a user token. The next time the user adds his task, he uses the token he was given
                                </p>
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    For example: {server ip address}/api/addNewTask/?userToken={userToken}?{otherParams}
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    URL example: {server ip address}/api/deleteTask/{taskId}/{userToken}
                                </p>
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            ...
                            <div>
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">updateTaskTitle</h2>
                                <h3 class="mt-5 text-xxl text-gray-900 dark:text-white">Method: POST</h3>
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    URL example: {server ip address}/api/updateTaskPriority?taskId={taskId}&userToken={userToken}&title={title}
                                </p>
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    Changing task title by task id and user token. Maximum symbols for title is 100.
                                </p>
                            </div>
